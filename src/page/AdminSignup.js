...
export default function AdminSignup() {
  ...
  const handlePwChange = (e) => {
    setFormAdminData.pw(e.target.value);
    validatePasswords(e.target.value.pw2);
  };

  const handlePw2Change = (e) => {
    setPw2(e.target.value);
    validatePasswords(formAdminData.pw, e.target.value);
  };
  ...
  const checkIdDuplicate = async () => {
    const { id } = formAdminData; // formAdminData에서 id 가져오기
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:8080/insertAdmin", formAdminData, {
        headers: { "Content-Type": "application/json" },
      })
      .then((e) => {
        navigate("/admin-login1111");
      });
  };
            ...
            <div className="signup_inform">
              ...
              <div className="signup_detail_address">
                ...
                <input
                  type="text"
                  name="detailAddress"
                  value={formAdminData.detailAddress}
                  onChange={handlerInputChange}
                ></input>
              </div>
              <div className="signup_phonenumber">
                ...
                <div
                  name="phoneNumber"
                  value={formAdminData.phoneNumnber}
                  onChange={handlerInputChange}
                >
                  <select>
